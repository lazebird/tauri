...
const { name, homepage, issuepage, releasepage, version, dependencies, devDependencies } = pkg;
const __APP_INFO__ = {
  pkg: { name, version, homepage, issuepage, releasepage, dependencies, devDependencies },
  git: {
